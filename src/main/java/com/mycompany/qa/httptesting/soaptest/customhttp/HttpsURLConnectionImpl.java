...
public class HttpsURLConnectionImpl extends HttpsURLConnection {
    ...
    static URL checkURL(URL var0) throws IOException {
        if (var0 != null && var0.toExternalForm().indexOf(10) > -1) {
            ...
            if (var1 != null) {
                throw new MalformedURLException(var1);
            } else {
                return var0;
            }
        }
    ...
    HttpsURLConnectionImpl(URL var1) throws IOException {
        super(var1);
    }
    ...
    public Principal getPeerPrincipal() throws SSLPeerUnverifiedException {
        ...
        throw new RuntimeException("getPeerPrincipal in HsUCI");
    }

    public Principal getLocalPrincipal() {
      //  return this.delegate.getLocalPrincipal();
        throw new RuntimeException("getLocalPrincipal in HsUCI");
    }
