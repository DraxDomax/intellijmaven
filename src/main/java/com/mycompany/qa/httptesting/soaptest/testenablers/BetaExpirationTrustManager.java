...
public class BetaExpirationTrustManager implements X509TrustManager {
    private final X509TrustManager innerTrustManager;

    public BetaExpirationTrustManager(X509TrustManager innerTrustManager) {
    ...
    public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
        // TODO: We can have an encrypted database of fingerprints and resolve the incoming X509 in order NOT to pass any counter-agent through the lenient HTTP-S validation methods
